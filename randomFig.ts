...
export const randomFig = async (): Promise<any> => {
    ...
    } else if (randomIndex < 1000) {
        id = "fig-000" + randomIndex;
    } else if (randomIndex < 10000) {
        id = "fig-00" + randomIndex;
    } else if (randomIndex < 15000) {
    ...
    try {
        ...
        let firstResponse = await axios.get(
            `https://rebrickable.com/api/v3/lego/minifigs/${id}/sets/?key=1940e6fc5741fb5fccb8643f3c735fd1`
        );
         // //api call voor minifig
        let response2 = await axios.get(
            `https://rebrickable.com/api/v3/lego/minifigs/${id}/?key=1940e6fc5741fb5fccb8643f3c735fd1`
        );
